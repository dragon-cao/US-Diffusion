...
class LatentDiffusion(DDPM):
    ...
    def forward(self, x, c, *args, **kwargs):
        ...
        # t_intervals[0] = 0
        # #non-uniform
        # t_intervals = torch.tensor([ 0, 175, 350, 525, 699, 759, 819, 879, 939, 998])
        ...
        # t_intervals = torch.tensor([0, 80, 289, 499, 619, 739, 819, 879, 939, 998])				
        #non-uniform
        t_intervals = torch.tensor([0, 80, 289, 499, 619, 739, 819, 879, 939, 998])				
								

        idx_1 = torch.randint(0, len(t_intervals), size=(x.shape[0] // 2 + 1,))
        idx_2 = len(t_intervals)-idx_1-1
        idx = torch.cat([idx_1, idx_2], dim=0)[:x.shape[0]]
