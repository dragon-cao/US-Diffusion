...
import random
import json
sys.path.append('/home/data_2t/cwl/US-Diffusion')
...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--task", type=str, default='', help="task to test")
...
def main():
    ...
    # Data
    dataset = EditDataset(path='/home/data_2t/cwl/US-Diffusion/data/clip-filtered-dataset',
                              split='test', prompt_option='output', task=opt.task)
    dataloader = DataLoader(dataset, batch_size=50, shuffle=False, num_workers=1)
