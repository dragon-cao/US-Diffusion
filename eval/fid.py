...
import scipy.linalg
import torch
sys.path.append('/home/device/cwl/Prompt-Diffusion')
...
python -m pytorch_fid /home/data_2t/cwl/Prompt-Diffusion2/images_lamda_0.1/inv_depth/original_images /home/data_2t/cwl/Prompt-Diffusion2/images_lamda_0.1/inv_depth/generated_images
 
    \b
    # Calculate FID
    torchrun --standalone --nproc_per_node=1 eval/fid.py calc --images=/home/device/cwl/Prompt-Diffusion/images/inv_seg/generated_images \\
        --ref=https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/cifar10-32x32.npz
    python -m pytorch_fid /home/data_2t/cwl/Prompt-Diffusion2/images_moe_jiaocha/inv_depth/original_images /home/data_2t/cwl/Prompt-Diffusion2/images_moe_jiaocha/inv_depth/generated_images
...
@click.option('--ref', 'ref_path',      help='Dataset reference statistics ', metavar='NPZ|URL',    type=str,default='/home/device/cwl/Prompt-Diffusion/images/inv_hed/original_images.npz', required=True)
